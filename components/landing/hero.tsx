    ...
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-24 bg-gradient-to-b from-[#F1F8F5] via-canvas to-surface border-b border-border/70">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-12 md:mt-16 mx-auto max-w-5xl">
          ...
          <div className="hidden lg:flex absolute -left-4 top-10 z-20 items-center gap-3 rounded-xl border border-border bg-surface p-3.5 shadow-md">
          ...
          <div className="hidden lg:flex absolute -right-4 top-20 z-20 items-center gap-3 rounded-xl border border-border bg-surface p-3.5 shadow-md">
          ...
          <div className="hidden lg:flex absolute -left-2 bottom-12 z-20 items-center gap-3 rounded-xl border border-border bg-surface p-3.5 shadow-md">
